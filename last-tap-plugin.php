...
require_once(dirname(__FILE__) . '/inc/callbacks/LastTap_AdminCallbacks.php');
...
require_once(dirname(__FILE__) . '/inc/callbacks/LastTap_EventCallbacks.php');
require_once(dirname(__FILE__) . '/inc/callbacks/LastTap_ManagerCallbacks.php');
require_once(dirname(__FILE__) . '/inc/callbacks/LastTap_LocationCallbacks.php');
require_once(dirname(__FILE__) . '/inc/callbacks/LastTap_NotificationCallbacks.php');
require_once(dirname(__FILE__) . '/inc/callbacks/LastTap_TestimonialCallbacks.php');
require_once(dirname(__FILE__) . '/inc/callbacks/LastTap_CptCallbacks.php');
require_once(dirname(__FILE__) . '/inc/callbacks/LastTap_TaxonomyCallbacks.php');
require_once(dirname(__FILE__) . '/inc/callbacks/LastTap_ParticipantCallbacks.php');
