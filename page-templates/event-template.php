    ...
    <div class="lastTap row">
        ...
        <div class="lastTap col-sm-3">
            <div class="lastTap panel panel-primary event-primary">
                <div class="lastTap panel-heading"><h2><a href="<?php echo $event_permalink;?>"><?php echo $event_title;?></a></h2></div>
                ...
                <div class="lastTap panel-footer panel-primary">
                    ...
                    <a href="<?php echo $event_permalink;?>" class="lastTap btn btn-success"><?php _e('Read more...','last-tap-event');?></a>
                </div>
            </div>
        </div>
    <?php } ?>
