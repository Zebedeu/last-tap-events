...
class LastTap_AdminCallbacks extends LastTap_BaseController
{
     ...
     public function lt_event_sanitize_color( $input ){
         ...
         $valid_fields = "";
            ...
            if( false === $this->check_color( $background ) ) {
                ...
                add_settings_error( 'lt_settings_options', 'lt_bg_error', __('Insert a valid color for border','last-tap-events'), 'error' ); // $setting, $code, $message, $type
    ...
    public function lt_event_sanitize_background_color( $input )
    {
            ...
            if( false === $this->check_color( $background ) ) {
                ...
                // Set the error message
                add_settings_error( 'lt_settings_options', 'lt_bg_error', __('Insert a valid color for button','last-tap-events'), 'error' ); // $setting, $code, $message, $type
    ...
    public function lt_event_sanitize_text_color( $input )
    {
        ...
        if( false === $this->check_color( $background ) ) {
            ...
            // Set the error message
            add_settings_error( 'lt_settings_options', 'lt_bg_error', __('Insert a valid color for text','last-tap-events'), 'error' ); // $setting, $code, $message, $type
