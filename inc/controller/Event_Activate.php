...
class Event_Activate
{
    public static function ev_activate()
    {
        flush_rewrite_rules();
        ...
        add_action( 'admin_init', array( 'Event_Activate', 'add_sub_caps' ) );
    }
    ...
    public static function add_sub_caps(string $roles = 'event_member')
    {
        ...
        //     $wp_role = new WP_Role;
        // }
        $result = $wp_role->add_role('event_role', __('Member', 'k7-event'),
            array(
