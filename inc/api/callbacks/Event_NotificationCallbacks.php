...
class Event_NotificationCallbacks extends Event_BaseController
{
    ...
    {
        $this->notify = new Event_NotificationController();
     ...
     */
    function ev_meta_box_callback($post)
    {

        // Add a nonce field
        wp_nonce_field('ev_meta_box', 'ev_meta_box_nonce');
