...
class Event_TaxonomyCallbacks
{
    public function ev_taxSectionManager()
    {
        echo 'Create as many Custom Taxonomies as you want.';
    }

    public function ev_taxSanitize($input)
    {
    ...
    public function ev_textField($args)
    {
        $name = $args['label_for'];
    ...
    public function ev_checkboxPostTypesField($args)
    {
        $output = '';
        $name = $args['label_for'];
        $classes = $args['class'];
