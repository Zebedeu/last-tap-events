 ...
 * @version 1.0.13
 *
 * @package K7Events/inc/api/widgets
 */

defined('ABSPATH') || exit;


class Event_LocationWidget extends \WP_Widget
{
    ...
    public function ev_register()
    {
        ...
        add_action('widgets_init', array($this, 'ev_register_location_widgets'));
    }
    ...
    public function form($instance)
    {
        ...
        ?>
        <p><?php _e( 'Select your options below', 'k7-event');?></p>
        <p>
            <label for="<?php echo $this->get_field_name('location_id'); ?>"><?php _e('Location to display', 'k7-event'); ?></label>
            <select class="widefat" name="<?php echo $this->get_field_name('location_id'); ?>"
                ...
                <option value="default"><?php _e('All Locations', ' k7-event'); ?></option>
                <?php
                $args = array(
                    'posts_per_page' => -1,
                    'post_type' => 'k7-event_locations'
                );
        ...
        <p>
            <small><?php _e('If you want to display multiple locations select how many below', 'k7-event'); ?></small>
            <br/>
            <label for="<?php echo $this->get_field_id('number_of_locations'); ?>"><?php _e('Number of Locations', 'k7-event'); ?></label>
...
//$args - arguments set by the widget area, $instance - saved values
    public function widget($args, $instance)
    {
        ...
        $arguments = array();
        $simple_locations = new Event_LocationController();
        ...
        $html .= $simple_locations->ev_get_locations_output($arguments);
    ...
    public function ev_register_location_widgets()
    {
