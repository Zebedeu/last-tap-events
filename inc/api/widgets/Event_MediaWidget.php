...
class Event_MediaWidget extends \WP_Widget
{
    public $widget_ID;
    ...
    public function ev_register()
    {
        ...
        add_action('widgets_init', array($this, 'ev_widgetsInit'));
    }

    public function ev_widgetsInit()
    {
    ...
    public function form($instance)
    {
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_attr_e('Title:', 'k7-event'); ?></label>
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>"
                   name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text"
                   value="<?php echo esc_attr($title); ?>">
        </p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('image')); ?>"><?php esc_attr_e('Image:', 'k7-event'); ?></label>
