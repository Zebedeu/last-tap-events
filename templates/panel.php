...
add_action('ev_UserPanelPublic', 'ev_PanelPublic', 10, 3);
function ev_PanelPublic($user_id, $length, $current_user)
{
    ...
    <div class="ch-row">
        <div class="ch-col-3 ch-menu">
            <ul>
                ...
                <li><?php echo __('Posts', 'k7-event') . "\t" . count_user_posts($user_id); ?></li>
                <li><?php echo __('Comments', 'k7-event') . "\t" . $count; ?></li>
                <li>*</li>
            </ul>
        </div>
        ...
        <div class="ch-col-9">
            ...
            <div class="ch-tab">
                <button class="ch-tablinks"
                        onclick="openTabs(event, 'tab1')"><?php echo __('Recent Activity', 'k7-event'); ?></button>
                <button class="ch-tablinks"
                        onclick="openTabs(event, 'tab2')"><?php echo __('Information', 'k7-event'); ?></button>
                <button class="ch-tablinks"
                        onclick="openTabs(event, 'tab3')"><?php echo __('ANOTHER', 'k7-event'); ?></button>
            </div>

            <div id="tab1" class="ch-tabcontent">
                <h3><?php _e( 'Activity', 'k7-event'); ?></h3>
            ...
            <div id="tab2" class="ch-tabcontent">
                <h3></h3>
                <div class="panelt">
                    <div class="ch-panel-heading"><?php _e( 'Email', 'k7-event'); ?><i class=""></i>
                    </div>
                    <div class="ch-body"><a
                ...
                <div class="ch-default">
                    <div class="ch-panel-heading"><?php _e( 'Website ', 'k7-event'); ?><i class=""></i>
                    </div>
                    <div class="ch-body"><a
            ...
            <div id="tab3" class="ch-tabcontent">
                <h3><?php _e( 'ANOTHER', 'k7-event'); ?></h3>
                <h2><?php echo __('Description', 'k7-event'); ?></h2>
