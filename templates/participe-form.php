...
<form id="event-participant-form" style="display: none;" action="#" method="post" data-url="<?php echo admin_url('admin-ajax.php'); ?>">
    ...
    <div class="field-container">
        <input type="text" class="field-input" placeholder="<?php esc_attr_e( 'Your Phone Number', 'last-tap-events' ) ?>" id="telephone"
               name="telephone" value="" >
        <small class="field-msg error"
               data-error="invalidTelephone"><?php _e( 'Your Phone Number is not valid', 'last-tap-events' ) ?></small>
    </div>
